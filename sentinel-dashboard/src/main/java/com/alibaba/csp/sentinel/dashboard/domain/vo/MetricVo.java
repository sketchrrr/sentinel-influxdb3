...
public class MetricVo implements Comparable<MetricVo> {
    ...
    public static MetricVo fromMetricEntity(MetricEntity entity) {
        ...
        vo.timestamp = entity.getTimestamp() != null ? entity.getTimestamp().getTime() : System.currentTimeMillis();
        vo.gmtCreate = entity.getGmtCreate() != null ? entity.getGmtCreate().getTime() : System.currentTimeMillis();
